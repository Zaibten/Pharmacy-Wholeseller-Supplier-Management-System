    ...
    <footer className="footer-container">
      <div className="footer-content">
        <div className="footer-logo-section">
          ...
          <p>
  <strong>Pharma Sync</strong> is a premium food delivery platform that redefines convenience by bringing your favorite meals from top restaurants right to your doorstep. Experience variety, speed, and satisfaction with every order.
</p>
...
<p>© 2025 Pharma Sync. All rights reserved. Designed with ❤️ for food lovers everywhere.</p>
      </div>
    </footer>
  );
};
