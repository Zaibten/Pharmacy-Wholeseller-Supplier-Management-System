  ...
  const htmlContent = `
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 20px;">
        ...
        <p style="font-size: 15px; margin-top: 30px;">Enjoy your meal!<br/><strong>Team Pharma Sync</strong></p>
      </div>
  ...
  const htmlContent = `
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 20px; color: #333;">
        ...
        <p style="font-size: 15px; margin-top: 30px;">Thank you,<br/><strong>Team Pharma Sync</strong></p>
      </div>
